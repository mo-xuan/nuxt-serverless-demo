...
<template>
  <div id="app">
    <div
        class="emoji-wrapper overflow-hidden row-span-2 p-1"
        ref="emojiWrapper"
    >
      <div
    ...
    <div
        class="rating flex-row-reverse justify-center items-center"
        @change="onChange"
    >
      <input
    ...
    <div class="col-span-2 text-center pt-1">
      Ranks: {{ currentRate.rate }}/10 {{ currentRate.total }}
    </div>
    <div
        class="col-span-2 alert alert-error"
        v-if="message"
    >
      <p>{{ message }}</p>
    </div>
